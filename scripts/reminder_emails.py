...
def generate_email(allSessions, child, message, nCompleted):
	...
	for child in children:
		...
		if sendEmail:
			...
			if not alreadySent:
				...
				(body, feedbackToSend) = generate_email(allSessions, child, message, len(theseSessions))
